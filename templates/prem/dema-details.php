...
<div class="container">
    <h4><font color="blueviolet">Demande N°= <?php echo $row['id_inter']; ?>  </font> </h4>
    <hr>
    <div class="row">
        <div class="col">
...
<form id="interventionForm">
    ...
    <div class="row">
        ...
        <div class="divbtn">
            <button type="button" class="btn btn-secondary" onclick="window.location.href='dema-lst.php'">Retour</button>
            <?php if(!$isClosed): ?>
...
<script>
            $(document).ready(function() {
                $('#openButton').click(function() {
                    swal({
                        title: "Are you sure?",
                        text: "You want to get this Demande ?.",
                        icon: "warning",
                        buttons: true,
                        dangerMode: true,
                    }).then((willOpen) => {
                ...
                $('#closeButton').click(function() {
                    swal({
                        title: "Are you sure?",
                        text: "Once closed, you cannot modify this Demande.",
                        icon: "warning",
                        buttons: true,
                        dangerMode: true,
                    }).then((willClose) => {
