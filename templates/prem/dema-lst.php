...
<?php include "conf/dema-lst-conf.php";?>

<div class="my-margin">
      <h2><font color="#ad0000">Liste des Demandes</font></h2>
  </div>
    ...
    <?php
          if ($rowCount > 0) {
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo "<td class='actions'><a href='dema-details.php?id_inter=". $row["id_inter"]. "'>View</a></td>";
                echo "</tr>";
        }
      } else {
